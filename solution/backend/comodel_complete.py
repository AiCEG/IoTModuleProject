...
def generate_ml_model():
    ...
    # Define callbacks
    model_checkpoint = ModelCheckpoint('room_occupancy_model.keras', monitor='val_loss', save_best_only=True, save_format='tf')
    model.summary()
    # Train the model
    ...
    model.save('room_occupancy_model_final.h5')
    print("Model saved as 'room_occupancy_model.h5'")

def load_and_predict(new_data):
    # Load the saved model
    model = load_model(f'room_occupancy_model_final.h5')
